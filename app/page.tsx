...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Fixed Indigo Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-indigo-600 border-b border-indigo-700">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <div className="flex items-center space-x-1 text-white hover:text-indigo-200 transition-colors cursor-pointer">
                <span>Product</span>
            ...
            <div className="flex items-center space-x-4">
              <Link href="/login" className="text-white hover:text-indigo-200 transition-colors">
                Log in
              </Link>
              <Link 
