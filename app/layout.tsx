...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  // Hide navbar on dashboard page, upgrade page, settings page, members page, and presentation editor pages
  const showNavbar = !pathname?.includes('/dashboard') && !pathname?.includes('/upgrade') && !pathname?.includes('/settings') && !pathname?.includes('/members') && !pathname?.includes('/presentation-editor');
