...
export default function MediaInsertionPlugin() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      console.log('🎯 MediaInsertionPlugin: INSERT_IMAGE_COMMAND value:', INSERT_IMAGE_COMMAND);
      ...
      console.log('🎯 MediaInsertionPlugin: Image command registered:', !!removeImageCommand);
      console.log('🎯 MediaInsertionPlugin: Video command registered:', !!removeVideoCommand);
