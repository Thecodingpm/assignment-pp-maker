    ...
    <div className="relative" ref={colorPickerRef}>
      ...
      <button
        ...
        onClick={(e) => {
          e.preventDefault();
          e.stopPropagation();
          console.log('Color picker clicked!', isOpen);
          setIsOpen(!isOpen);
        }}
        className={`w-8 h-8 border border-gray-300 rounded cursor-pointer ${className}`}
        style={{ backgroundColor: value }}
        title="Text color"
      />

      {/* Color Picker Popup */}
      {console.log('ColorPicker render - isOpen:', isOpen)}
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-[9999] bg-white rounded-lg shadow-2xl border border-gray-200 min-w-64 max-w-72"
              style={{
