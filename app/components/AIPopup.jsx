        ...
        <div className="p-6">
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="e.g., Create a business pitch deck for a sustainable energy startup with 5 slides covering problem, solution, market, business model, and team..."
          ...
          <div className="text-sm text-gray-500 mb-4">
            ...
            <p>🎯 Be specific about content, style, and number of slides for better results</p>
          </div>
        </div>
